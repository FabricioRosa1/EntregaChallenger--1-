...
public class PagamentoDao {
	...
	public void gravar (PagamentoModel transacao) {
		...
		try {
			...
			ps_transacao.setInt(2, Integer.parseInt(transacao.getNumeroCartao()));
			ps_transacao.setString(3, transacao.getTitularCartao());
			ps_transacao.setInt(4, transacao.getCvv());
			ps_transacao.setDate(5, Date.valueOf(transacao.getValidadeCartao()));
			ps_transacao.setInt(6, transacao.getQtdParcelas());
	...
	public void editarU (PagamentoModel transacao) {
		...
		try {
			...
			ps_transacao.setInt(1, Integer.parseInt(transacao.getNumeroCartao()));
		...
		try {
            ...
            if(res.next()) {
                do {
                    ...
                    transacao.setNumeroCartao(String.valueOf(res.getInt("NR_CARTAO")));
